...
import com.buff.common.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "buffalo";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        // 同步锁，保证用户账号唯一，防止并发，使用intern()方法，将字符串常量池化
    ...
    @Override
    public boolean updateUserSignById(User user) {
        String userAccount = user.getUserAccount();
        if (StringUtils.isAnyBlank(String.valueOf(user.getId()))) {
